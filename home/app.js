document.getElementById("one").style.setProperty('--animate-duration', '2s');
document.getElementById("two").style.setProperty('--animate-duration', '3s');
document.getElementById("three").style.setProperty('--animate-duration', '4s');
